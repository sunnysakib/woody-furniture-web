...
<body>
	...
	<nav class="custom-navbar navbar navbar-expand-md navbar-dark sticky-top">
		<div class="container">
			...
			<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarsWoody"
				aria-controls="navbarsWoody" aria-expanded="false" aria-label="Toggle navigation">
				...
				<ul class="custom-navbar-icon navbar-nav mb-2 mb-md-0 ms-5">
					<li class="dropdown my-auto">
						...
						<ul class="dropdown-menu">
							<li>
								<a id="loginn" class="dropdown-item" href="login.html">Login</a>
							</li>
							<li>
	...
	<section class=" container product-detail">
		<div class="  row">
			<div class="col product-img">
				<img class="img-fluid w-100 product-thumbnail"
					src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['image']); ?>" />
			</div>
			<div class="product-text-field col mt-5 pt-3">
				...
				<div class="w-100">
					<div class="btn-group" aria-label="Basic mixed styles example">
						<button type="button" class="btn rounded-4 product-item-input">-</button>
						<button type="button" class="btn product-item-input " disible>1</button>
						<button type="button" class="btn text-black btn rounded-4 product-item-input">+</button>
					</div>
		...
		<div class="mt-5 mb-5 pb-5">
			...
			<div class="row my-5">
				<?php
				$counter = 0;
				while ($product = $products->fetch_assoc() and $counter < 4) {
					?>
					<div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
						<a class="product-item" href="productDetail.php?id=<?php echo $product['product_id']; ?>">
			...
			<a href="shop.php" class="fs-5">View More</a>
			</div>
		</div>
	</section>
		...
		<div class="container relative">
			...
			<div class="row g-5 mb-5">
				<div class="col-lg-4">
					...
					<p class="mb-4">we understand that buying furniture is more than a transaction, it's an investment
						in your comfort and style. Our services are tailored to make your shopping experience enjoyable
						and hassle-free.</p>
			...
			<div class="border-top copyright">
				<div class="row pt-4">
					<div class="col-lg-6">
						<p class="mb-2 text-center text-lg-start">Copyright &copy; 2028. All Rights Reserved. &mdash;
							Woody
						</p>
					</div>
